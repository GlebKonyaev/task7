"""Module for processing the command line and launching applications

This module provides:
  ArgParser class for processing command line arguments
  The main() function for launching applications

Main functions:
    ArgParser: Parsing command line arguments
    main(): The entry point to the application

Usage example:
    python -m monaco.cli --files ".\data" --desc
"""
...
from example_package_gleb_koniaev.monaco.report_printer import ReportPrinter
...
def main():
    ...
    printer.print_report(args.driver)
